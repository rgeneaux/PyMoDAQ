...
for klass in (DataRaw, DataWithAxes, DataToExport, DataCalculated, Axis, NavAxis,
               DataFromPlugins, DataActuator, DataScan, DataToActuators):
    if SerializableBase in klass.__mro__:
        ser_factory.register_from_type(klass, klass.serialize, klass.deserialize)